        ...
        children: [
          AppBar(
            ...
            title: InkWell(
              ...
              //   ),
              // ),
              splashColor: Color(0xff56ab2f),
              focusColor: Color(0xff56ab2f),
              highlightColor: Color(0xff56ab2f),
              hoverColor: Color(0xff56ab2f),
              child: Container(
      ...
      return Align(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                  // color: isMe ? Color(0xff56ab2f) : Color(0xffa8e063),
                  color: Colors.white,
                  fontSize: 16.0,
                ),
              )
          ...
          decoration: BoxDecoration(
            color: isMe ? Color(0xffa8e063) : Color(0xff56ab2f),
            borderRadius: isMe
                ? BorderRadius.only(
